                    ...
                    <div class="container container-fixed colsStack spr-page">
                        ...
                        <div class="col col-sm-12 col-lg-4 col-md-4">
                            ...
                            <a class="imageModuleWrap" id="w_m7022">
                                <img id="m7022" class="module image inline-icon"
                            ...
                            <a id="m1570" class="module button spr-btn-mb" href="<?php echo esc_url(home_url('/')); ?>testimonials" title="" role="button"
                            ...
                            <a class="imageModuleWrap" id="w_m7024"> <img id="m7024" class="module image inline-icon"
                            ...
                            <a id="m4553" class="module button spr-btn-mb" href="<?php echo esc_url(home_url('/products-and-services')); ?>" title="" role="button"
                               data-track-event="click" data-track-action="internal_link_clicked"><i
