            ...
            <?php if (is_page([815])) : ?>
              ...
              <?php if (have_rows('testimony')): ?>
                ...
                <?php while (have_rows('testimony')) : the_row(); ?>
                  ...
                  <h1><?php the_title(); ?> - Testimonials</h1>
                  ...
                  <div id="m1779" class="module text spr-testimonial-txt">
                    ...
                    <p><strong><?php echo the_sub_field('testament_author'); ?><?php if (get_sub_field("author_contact_number")): ?>,
                          <a
                            href="tel:<?php echo the_sub_field('author_contact_number'); ?>"><?php echo the_sub_field('author_contact_number'); ?></a>
                          <br><?php echo the_sub_field('author_title'); ?>
                        <?php endif; ?>
                      </strong>
                    </p>
                  </div>
                  ...
                  <div class="spr-testimonial-txt-aside">
                    ...
                    <p>
                      <strong><?php echo the_sub_field('testament_author'); ?><?php if (get_sub_field("author_contact_number_aside")): ?>,
                          <a
                            href="tel:<?php echo the_sub_field('author_contact_number_aside'); ?>"><?php echo the_sub_field('author_contact_number_aside'); ?></a>
                          <br><?php echo the_sub_field('author_title'); ?>
                        <?php endif; ?>
                      </strong>
                    </p>
          ...
          <div class="col col-md-4 col-lg-4 col-sm-12">
            ...
            <div id="m1727" class="module text">
              ...
              <div class="map-responsive">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2551.9245678175985!2d-119.08774538368503!3d50.23731411057953!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x537dd0c193bb372d%3A0x3067775b2eb8630b!2s5770+Petworth+Rd%2C+Coldstream%2C+BC!5e0!3m2!1sen!2sca!4v1553267440980"
